...
export type ModifierDefinitionUid = Uid & { readonly __modifier_uid_tag: unique symbol };
...
export type ShapeObjectDefinitionUid = Uid & { readonly __shapeobject_uid_tag: unique symbol };
